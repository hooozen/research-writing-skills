...
| Skill | Purpose |
|---|---|
| [`research-progress-report`](skills/research-progress-report/) | Draft or revise evidence-led progress reports for different languages, audiences, and public or lab-meeting contexts. Outputs Markdown or HTML and keeps charts paired with exact-value tables. |
